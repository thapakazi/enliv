...
var rootCmd = &cobra.Command{
	Use:   "enliv",
	Short: "enliv - cli tool made with <3 to explore enliv",
	Long: `exploring enliv made fun with <3
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.enliv.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".enliv" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".enliv")
	}
